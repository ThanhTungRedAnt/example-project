...
public class UserResource {
    ...
    public UserResource(AdminUserService adminUserService, UserRepository userRepository) {
    ...
    public ResponseEntity<UserDTO> updateUser(@Valid @RequestBody UserDTO userDTO) {
        ...
        Optional<UserDTO> updatedUser = adminUserService.updateUser(userDTO);
    ...
    public ResponseEntity<List<UserDTO>> getAllUsers(Pageable pageable) {
        ...
        final Page<UserDTO> page = adminUserService.getAllManagedUsers(pageable);
    ...
    public List<String> getAuthorities() {
        return adminUserService.getAuthorities();
    }
    ...
    public ResponseEntity<UserDTO> getUser(@PathVariable String login) {
        ...
        return ResponseUtil.wrapOrNotFound(
            adminUserService.getUserWithAuthoritiesByLogin(login)
                .map(UserDTO::new));
    }
    ...
    public ResponseEntity<Void> deleteUser(@PathVariable String login) {
        ...
        adminUserService.deleteUser(login);
